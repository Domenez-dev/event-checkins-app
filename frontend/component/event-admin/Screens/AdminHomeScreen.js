...
import { View, Text, Button, FlatList,KeyboardAvoidingView,StyleSheet } from "react-native";
    ...
    <View style={styles.container}>
            ...
            <View style={styles.buttonsContainer}>
              ...
              <Button
                ...
                onPress={() => {
                  ...
                  //   params: { mode: "view" },
                  // });
                   navigation.navigate("Screens/EventFormScreen", { mode: "view" });
                }}
              />
            </View>
          </View>
      ...
      <Button
        ...
        onPress={() => {
          ...
          //   params: { mode: "edit" },
          // });
           navigation.navigate("Screens/EventFormScreen", { mode: "edit" });
        }}
      />
    </View>
  );
